...
type WebAdapter struct {
	handlers tokenauth.TokenAuthHandlers
}
...
func (we WebAdapter) tokenAuthWrapFunc(handler http.HandlerFunc, authorization tokenauth.TokenAuthHandler) http.HandlerFunc {
...
func NewWebAdapter(handlers tokenauth.TokenAuthHandlers) WebAdapter {
...
func main() {
	...
	authHandlers := tokenauth.NewTokenAuthHandlers(tokenauth.NewScopeTokenAuthHandler(*tokenAuth))
