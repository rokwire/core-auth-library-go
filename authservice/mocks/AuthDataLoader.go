...
func (_m *AuthDataLoader) GetAccessToken(token string, path string) (string, error) {
...
// GetDeletedAccounts provides a mock function with given fields: token, path
func (_m *AuthDataLoader) GetDeletedAccounts(token string, path string) ([]string, error) {
	ret := _m.Called(token, path)
